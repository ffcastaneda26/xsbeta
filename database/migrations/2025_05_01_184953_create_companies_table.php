...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            $table->foreignIdFor(Country::class)->default(env('APP_DEFAULT_COUNTRY_ID',44))->comment('País');
            $table->foreignIdFor(State::class)->default(env('APP_DEFAULT_STATE_ID',2824))->comment('Entiad Federativa');
            $table->foreignIdFor(City::class)->default(env('APP_DEFAULT_CITY_ID',19111))->comment('Entiad Federativa');
